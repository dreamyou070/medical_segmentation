...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, mid_channels=None, norm_type='batchnorm', non_linearity='relu'):
        super().__init__()
        if not mid_channels:
        ...
        if norm_type == 'batchnorm':
            ...
            norm_layer = nn.LayerNorm([mid_channels, int(20480 / mid_channels), int(20480 / mid_channels)])
